...
QMutex CSqlConnectionPool::mutex;
QWaitCondition CSqlConnectionPool::waitConnection;
CSqlConnectionPool* CSqlConnectionPool::instance = NULL;
...
CSqlConnectionPool & CSqlConnectionPool::getInstance()
{
    if (NULL == instance)
    {
        ...
        if (NULL == instance)
        {
            instance = new CSqlConnectionPool();
        }
    }
...
QSqlDatabase CSqlConnectionPool::openConnection()
{
    CSqlConnectionPool & pool = CSqlConnectionPool::getInstance();
