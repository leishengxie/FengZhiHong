...
#define LINE_5      10000   // 五连，五枚同色棋子在一条线上邻接连串。
#define LINE_LONG   10000   // 长连,五枚以上同色棋子在一条线上邻接成串
#define BECOME_5    10000   // 成五,五连和长连的统称
//〖威胁〗下一手可以成五或者活四的点。
//跳冲四
//〖四〗五连去掉1子的棋型。
#define LIVE_4      1000    // 活四, two head, 有两个威胁的四
#define SINGLE_4    500     // 冲四, one head, middle,只有一个威胁的四
#define DEAD_4      0       // 死四, 不能成五的四
...
//假活三, 在活三两端相隔一点的位置上有对方的棋子(或边线)阻拦时，这个看起来是活三的棋形实际上是个假活三
#define SLEEP_3     200     // 眠三,再走一着可以形成冲四的三
