...
void CLMapleLeafStyle::drawPEPanelButtonCommand(const QStyleOption* option, QPainter* painter) const
{
...
QPainterPath CLMapleLeafStyle::roundRectPath(const QRect & rect)
{
