#ifndef CLNORWEGIANWOODSTYLE_H
#define CLNORWEGIANWOODSTYLE_H

#include <QProxyStyle>


class CLNorwegianWoodStyle : public QProxyStyle
{
    Q_OBJECT
public:
    explicit CLNorwegianWoodStyle(QStyle *style = Q_NULLPTR);
