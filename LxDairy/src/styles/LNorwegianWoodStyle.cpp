...
CLNorwegianWoodStyle::CLNorwegianWoodStyle(QStyle* style)
...
/// \param palette
///
void CLNorwegianWoodStyle::polish(QPalette & palette)
{
...
void CLNorwegianWoodStyle::polish(QWidget* widget)
{
...
void CLNorwegianWoodStyle::unpolish(QWidget* widget)
{
...
/// \return
///
int CLNorwegianWoodStyle::styleHint(QStyle::StyleHint which, const QStyleOption* option, const QWidget* widget, QStyleHintReturn* returnData) const
{
//    switch (which)
//    {
...
int CLNorwegianWoodStyle::pixelMetric(QStyle::PixelMetric which, const QStyleOption* option, const QWidget* widget) const
{
//    switch (which)
//    {
...
void CLNorwegianWoodStyle::drawPrimitive(QStyle::PrimitiveElement which, const QStyleOption* option
...
void CLNorwegianWoodStyle::drawControl(QStyle::ControlElement element, const QStyleOption* option
                                   , QPainter* painter, const QWidget* widget) const
{
...
void CLNorwegianWoodStyle::drawComplexControl(QStyle::ComplexControl which, const QStyleOptionComplex* option
        , QPainter* painter, const QWidget* widget) const
{
    switch (which)
    {
...
QRect CLNorwegianWoodStyle::subControlRect(QStyle::ComplexControl whichControl, const QStyleOptionComplex* option
...
/// \return
///
QPixmap CLNorwegianWoodStyle::standardPixmap(QStyle::StandardPixmap standardPixmap, const QStyleOption* opt
...
QIcon CLNorwegianWoodStyle::standardIcon(QStyle::StandardPixmap standardIcon, const QStyleOption* option
                                     , const QWidget* widget) const
{
    switch (standardIcon)
    {
...
bool CLNorwegianWoodStyle::event(QEvent* e)
{
    return QProxyStyle::event(e);
}

void CLNorwegianWoodStyle::drawPECheckBoxIndicator(const QStyleOption* option, QPainter* painter) const
{
    //commonstyle源码
...
void CLNorwegianWoodStyle::drawPERadioButtonIndicator(const QStyleOption* option, QPainter* painter) const
{
    // 源码
//    QRect ir = opt->rect;
...
void CLNorwegianWoodStyle::drawPEArrowDownIndicator(const QStyleOption* option, QPainter* painter) const
{

}

void CLNorwegianWoodStyle::drawPEPanelButtonCommand(const QStyleOption* option, QPainter* painter) const
{
...
/// \param pixmap
///
void CLNorwegianWoodStyle::setTexture(QPalette & palette, QPalette::ColorRole role,
...
QPainterPath CLNorwegianWoodStyle::roundRectPath(const QRect & rect)
{
